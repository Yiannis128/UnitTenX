...
def call_claude(messages: List[MessageParam], system: str = '', model: str = CLAUDE_3_5_SONNET):
...
# Add all variabels to the template
prompt = symbolic_test_prompt.format(...)

messages = [
    {'role': 'user', 'content': prompt},
]
print(call_claude(messages, model = CLAUDE_3_5_SONNET).content[0].text)
...
# Add all variabels to the template
formatted_unit_test_prompt = unit_test_prompt.format(...)

messages = [
    {'role': 'user', 'content': formatted_unit_test_prompt},
]
print(call_claude(messages, model = CLAUDE_3_5_SONNET).content[0].text)
...
messages = [
    {'role': 'user', 'content': formatted_reflection_prompt},
]
print(call_claude(messages, model = CLAUDE_3_5_SONNET).content[0].text)
